...
def printMatrix():
        ...
        for i in range(0,BOARD_SIZE):
            for j in range(0,BOARD_SIZE):
                ...
                label = myfont.render(str(tileMatrix[i][j]),1,(BLACK))
                label2 = scorefont.render("YourScore:"+str(TOTAL_POINTS),1,(DEEP_PURPLE))
                SURFACE.blit(label,(i*(400/BOARD_SIZE)+30,j*(400/BOARD_SIZE)+130))
                SURFACE.blit(label2,(75,30))
...
def printGameOver():
    ...
    label = scorefont.render("GameOver!",1,(PURPLE))
